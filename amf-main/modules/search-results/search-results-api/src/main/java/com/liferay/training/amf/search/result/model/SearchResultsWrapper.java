...
public class SearchResultsWrapper
	extends BaseModelWrapper<SearchResults>
	implements ModelWrapper<SearchResults>, SearchResults {
	...
	@Override
	protected SearchResultsWrapper wrap(SearchResults searchResults) {
