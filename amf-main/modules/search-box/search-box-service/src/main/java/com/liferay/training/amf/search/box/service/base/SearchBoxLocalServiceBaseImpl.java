 ...
 * @generated
 */
public abstract class SearchBoxLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SearchBoxLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SearchBoxLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SearchBoxLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SearchBox.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return searchBoxPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return searchBoxPersistence.countWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<SearchBox>() {
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return searchBoxPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public BasePersistence<SearchBox> getBasePersistence() {
	...
	public List<SearchBox> getSearchBoxesByUuidAndCompanyId(
		...
		return searchBoxPersistence.findByUuid_C(
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SearchBoxLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		searchBoxLocalService = (SearchBoxLocalService)aopProxy;

		_setLocalServiceUtilService(searchBoxLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SearchBoxLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, searchBoxLocalService);
		}
