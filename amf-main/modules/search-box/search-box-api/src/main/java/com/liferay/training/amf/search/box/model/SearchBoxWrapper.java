...
public class SearchBoxWrapper
	extends BaseModelWrapper<SearchBox>
	implements ModelWrapper<SearchBox>, SearchBox {
	...
	@Override
	protected SearchBoxWrapper wrap(SearchBox searchBox) {
		return new SearchBoxWrapper(searchBox);
	}
